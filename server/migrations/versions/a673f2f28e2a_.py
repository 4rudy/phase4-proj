...
Revision ID: a673f2f28e2a
Revises: d2642d830d3d
Create Date: 2023-12-21 23:13:26.787766
...
revision = 'a673f2f28e2a'
down_revision = 'd2642d830d3d'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['region'], ['regions.id'], name='fk_builds_region_regions'),
    sa.PrimaryKeyConstraint('id')
    )
